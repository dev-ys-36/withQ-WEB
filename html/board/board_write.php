                    ...
                    <div class="col d-flex justify-content-center">
						<div class="card border-primary mb-3" style="width: 40rem;">
							<div class="card-body text-primary">
								<div class="card-text">
									<form name="login_form" class="box" action="/write_check" method="POST">
										<h3 class="display-5 fw-bolder text-black mb-2">글쓰기</h3>
										<p class="text-muted">.</p>
										<input type="text" id="title" name="title" placeholder="Title" class="form-control">
										<br>
                                        <textarea id="content" name="content" placeholder="Content" rows="5" class="form-control" ></textarea>
										<br>
										<input type="submit" id="write" value="글쓰기" class="btn btn-outline-primary">
									</form>
								</div>
							</div>
						</div>
